<div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="{$engine->domain}">4um Engine</a>
          </div>
          <div class="sidebar-brand sidebar-brand-sm">
            <a href="{$engine->domain}">4um</a>
          </div>
          <ul class="sidebar-menu">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a href="{$engine->domain}/admin/index.php?action=users-list">Lista użytkowników</a></li> 
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="{$engine->domain}/admin/add-rank">Dodaj rangę</a></li>
