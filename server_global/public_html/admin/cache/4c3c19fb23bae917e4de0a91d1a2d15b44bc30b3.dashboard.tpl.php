...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  ...
  'unifunc' => 'content_5e24ba2bb9d526_15622969',
...
function content_5e24ba2bb9d526_15622969 (Smarty_Internal_Template $_smarty_tpl) {
?>
  <div id="app">
      ...
      <nav class="navbar navbar-expand-lg main-navbar">
        ...
        <ul class="navbar-nav navbar-right">
          ...
          <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
            <img alt="image" src="http://4um.pl/upload/avatar/5.png" class="rounded-circle mr-1">
            <div class="d-sm-none d-lg-inline-block">Witaj, program</div></a>
            <div class="dropdown-menu dropdown-menu-right">
              <div class="dropdown-title">Logged in 5 min ago</div>
              <a href="http://4um.pl/admin/profile" class="dropdown-item has-icon">
                <i class="far fa-user"></i> Profil
              </a>
              <a href="http://4um.pl/admin/setting" class="dropdown-item has-icon">
                <i class="fas fa-cog"></i> Ustawienia
              </a>
              <div class="dropdown-divider"></div>
              <a href="http://4um.pl/admin/logout" class="dropdown-item has-icon text-danger">
                <i class="fas fa-sign-out-alt"></i> Wyloguj
              </a>
            </div>
          </li>
        </ul>
      </nav>      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="http://4um.pl">4um Engine</a>
          </div>
          <div class="sidebar-brand sidebar-brand-sm">
            <a href="http://4um.pl">4um</a>
          </div>
          <ul class="sidebar-menu">
            <li class="menu-header">Kokpit</li>
            <li><a class="nav-link" href="blank.html"><i class="fas fa-fire"></i> <span>Statystyki</span></a></li>
            
            <li class="menu-header">Strefa zarządzania</li>
            <li class="dropdown">
              <a href="#" class="nav-link has-dropdown"><i class="far fa-user"></i> <span>Użytkownicy</span></a>
              <ul class="dropdown-menu">
                <li><a href="http://4um.pl/admin/index.php?action=users-list">Lista użytkowników</a></li> 
                <li><a href="#">Uprawnienia użytkowników</a></li> 
                <li><a href="#">Zbanowane konta</a></li> 
                <li><a href="http://4um.pl/admin/bans-list">Lista banów</a></li> 
              </ul>
            </li>
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="http://4um.pl/admin/add-rank">Dodaj rangę</a></li>
            ...
            <li class="menu-header">4um Engine</li>
            <li class="dropdown">
